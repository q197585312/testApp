...
public class LobbyDragonTigerFragment extends BaseFragment {
...
//    }
    ...
    public void initUI() {
        baseActivity.mAppViewModel.getDragonTiger01().setTimer(0);
        baseActivity.mAppViewModel.getDragonTiger01().setBigRoadOld("");
    ...
    public void updateTimer() {
        ...
        if (dragonTigerTimer01 == 0 && baseActivity.mAppViewModel.getDragonTiger01().getTimer() > 0) {
            if (!dragenTigerGameNumber01.equals(baseActivity.mAppViewModel.getDragonTiger01().getShoeNumber() + baseActivity.mAppViewModel.getDragonTiger01().getGameNumber())) {
                dragenTigerGameNumber01 = baseActivity.mAppViewModel.getDragonTiger01().getShoeNumber() + baseActivity.mAppViewModel.getDragonTiger01().getGameNumber();
                dragonTigerTimer01 = baseActivity.mAppViewModel.getDragonTiger01().getTimer();
            }
    ...
    public void updateInterface() {
        if (dragonTigerTimer01 > 0) {
            ...
            tv_baccarat_shoe_number01.setText("" + baseActivity.mAppViewModel.getDragonTiger01().getShoeNumber() + " - " + baseActivity.mAppViewModel.getDragonTiger01().getGameNumber());
        } else {
...
//            }
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        shufflingTv = (TextView) rootView.findViewById(R.id.gd__tv_shuffling);

        baseActivity.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        InitControl();
        baseActivity.mAppViewModel.getDragonTiger01().setShoeNumberOld(baseActivity.mAppViewModel.getDragonTiger01().getShoeNumber());
        baseActivity.titleTv.setText(getString(R.string.dragon_tiger).toUpperCase());
...
//                mContext,baccarat_big_road2,6,density,1);
        baseActivity.mAppViewModel.updateDragenTigerRoad(mContext, density, baseActivity.mAppViewModel.getDragonTiger01(), baccarat_head_road1, baccarat_big_road1, baccarat_bigeyes_road1, baccarat_smalleyes_road1, baccarat_roach_road1
    ...
    public void InitControl() {
        ...
        tv_baccarat_table_name = (TextView) rootView.findViewById(R.id.gd__tv_baccarat_table_name);
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ll_big_road_parent2 = rootView.findViewById(R.id.gd__ll_big_road_parent2);
            hsv_small_road_1 = rootView.findViewById(R.id.gd__hsv_small_road_1);
            hsv_small_road_2 = rootView.findViewById(R.id.gd__hsv_small_road_2);
            hsv_small_road_3 = rootView.findViewById(R.id.gd__hsv_small_road_3);
        } else {
            ll_big_road_parent2 = rootView.findViewById(R.id.gd__ll_big_road_parent2_landscape);
            hsv_small_road_1 = rootView.findViewById(R.id.gd__hsv_small_road_1_landscape);
            hsv_small_road_2 = rootView.findViewById(R.id.gd__hsv_small_road_2_landscape);
            hsv_small_road_3 = rootView.findViewById(R.id.gd__hsv_small_road_3_landscape);
        }
        ...
        smallway2 = rootView.findViewById(R.id.gd__baccarat_gridlayout4);
        smallway3 = rootView.findViewById(R.id.gd__baccarat_gridlayout5);
        bigway1 = rootView.findViewById(R.id.gd__big_way);
 ...
 /*       ((TextView) findViewById(R.id.gd__tv_banker_road)).setText("D");
    ...
    private List<String> getLimitData(int tableId) {
        ...
        String limit3 = "0 - 0";
        String limit4 = "0 - 0";
        DragonTiger dragonTiger = baseActivity.mAppViewModel.getDragonTiger01();
        if (dragonTiger != null) {
