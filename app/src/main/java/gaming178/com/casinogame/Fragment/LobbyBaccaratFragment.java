...
public class LobbyBaccaratFragment extends BaseFragment {
...
//    GridBackgroundView baccarat_background_head_road1;
    ...
    private void updateToolbarUserInfo() {
        baseActivity.toolbar_right_top_tv.setText(baseActivity.mAppViewModel.getUser().getName());
        baseActivity.toolbar_right_bottom_tv.setText(baseActivity.mAppViewModel.getUser().getBalance() + "");
    }

    private void updateShuffling() {
        if (baseActivity.mAppViewModel.getBaccarat(1).getGameStatus() == 8) {
            shuffling1.setVisibility(View.VISIBLE);
        } else {
            shuffling1.setVisibility(View.GONE);
        }
        if (baseActivity.mAppViewModel.getBaccarat(2).getGameStatus() == 8) {
            shuffling2.setVisibility(View.VISIBLE);
        } else {
            shuffling2.setVisibility(View.GONE);
        }
        if (baseActivity.mAppViewModel.getBaccarat(3).getGameStatus() == 8) {
            shuffling3.setVisibility(View.VISIBLE);
        } else {
            shuffling3.setVisibility(View.GONE);
        }
        if (baseActivity.mAppViewModel.getBaccarat(61).getGameStatus() == 8) {
            shuffling61.setVisibility(View.VISIBLE);
        } else {
            shuffling61.setVisibility(View.GONE);
        }
        if (baseActivity.mAppViewModel.getBaccarat(62).getGameStatus() == 8) {
            shuffling62.setVisibility(View.VISIBLE);
        } else {
            shuffling62.setVisibility(View.GONE);
        }
        if (baseActivity.mAppViewModel.getBaccarat(63).getGameStatus() == 8) {
            shuffling63.setVisibility(View.VISIBLE);
        } else {
            shuffling63.setVisibility(View.GONE);
        }
        if (shuffling7 != null) {
            if (baseActivity.mAppViewModel.getBaccarat(71).getGameStatus() == 8) {
    ...
    public void initUI() {
        for (int i = 1; i <= 3; i++) {
            baseActivity.mAppViewModel.getBaccarat(i).setTimer(0);
            baseActivity.mAppViewModel.getBaccarat(i).setBigRoadOld("");
        }
        for (int i = 61; i <= 63; i++) {
            baseActivity.mAppViewModel.getBaccarat(i).setTimer(0);
            baseActivity.mAppViewModel.getBaccarat(i).setBigRoadOld("");
    ...
    private void initUI71() {
        baseActivity.mAppViewModel.getBaccarat71().setTimer(0);
        baseActivity.mAppViewModel.getBaccarat71().setBigRoadOld("");
        baccaratTimer71 = 0;
    ...
    public void onResume() {
        super.onResume();
        if (baseActivity.mAppViewModel.isbLogin()) {
            initUI();
...
//    }
    ...
    public void updateTimer(int start, int end) {
        for (int i = start; i <= end; i++) {
            if (getBaccaratTimer(i) == 0 && baseActivity.mAppViewModel.getBaccarat(i).getTimer() > 0) {
                if (!getBaccaratGameNumber(i).equals(baseActivity.mAppViewModel.getBaccarat(i).getShoeNumber() + baseActivity.mAppViewModel.getBaccarat(i).getGameNumber())) {
                    setBaccaratGameNumber(i, baseActivity.mAppViewModel.getBaccarat(i).getShoeNumber() + baseActivity.mAppViewModel.getBaccarat(i).getGameNumber());
                    setBaccaratTimer(i, baseActivity.mAppViewModel.getBaccarat(i).getTimer());
                }
            }
        }
        if (end == 3) {
    ...
    public void updateInterface(int start, int end) {
        for (int i = start; i <= end; i++) {
            if (getBaccaratTimer(i) > 0) {
                ...
                getBaccaratShoeGameNumberTextView(i).setText("" + baseActivity.mAppViewModel.getBaccarat(i).getShoeNumber() + " - " + baseActivity.mAppViewModel.getBaccarat(i).getGameNumber());
            } else {
...
//                }
    ...
    public void updateInterface71() {
        ...
        if (baccaratTimer71 > 0) {
            ...
            tv_baccarat_shoe_number71.setText("" + baseActivity.mAppViewModel.getBaccarat71().getShoeNumber() + " - " + baseActivity.mAppViewModel.getBaccarat71().getGameNumber());
        } else {
...
//            }
    ...
    public void updateTimer71() {
        if (baccaratTimer71 == 0 && baseActivity.mAppViewModel.getBaccarat71().getTimer() > 0) {
            if (!baccaratGameNumber71.equals(baseActivity.mAppViewModel.getBaccarat71().getShoeNumber() + baseActivity.mAppViewModel.getBaccarat71().getGameNumber())) {
                baccaratGameNumber71 = baseActivity.mAppViewModel.getBaccarat71().getShoeNumber() + baseActivity.mAppViewModel.getBaccarat71().getGameNumber();
                baccaratTimer71 = baseActivity.mAppViewModel.getBaccarat71().getTimer();
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        baseActivity.titleTv.setVisibility(View.VISIBLE);
        baseActivity.titleTv.setText(getString(R.string.baccarat).toUpperCase());
...
//        }
    ...
    private void initShoeNumber() {
        for (int i = 1; i <= 3; i++) {
            baseActivity.mAppViewModel.getBaccarat(i).setShoeNumberOld(baseActivity.mAppViewModel.getBaccarat(i).getShoeNumber());
        }
        for (int i = 61; i <= 63; i++) {
            baseActivity.mAppViewModel.getBaccarat(i).setShoeNumberOld(baseActivity.mAppViewModel.getBaccarat(i).getShoeNumber());
        }
        baseActivity.mAppViewModel.getBaccarat71().setShoeNumberOld(baseActivity.mAppViewModel.getBaccarat71().getShoeNumber());
        baseActivity.toolbar_right_top_tv.setText(baseActivity.mAppViewModel.getUser().getName());
        baseActivity.toolbar_right_bottom_tv.setText(baseActivity.mAppViewModel.getUser().getBalance() + "");
    }
...
//                mContext,baccarat_big_road2,6,density,1);
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(1), baccarat_head_road1, baccarat_big_road1, baccarat_bigeyes_road1, baccarat_smalleyes_road1, baccarat_roach_road1
        ...
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(2), baccarat_head_road2, baccarat_big_road2, baccarat_bigeyes_road2, baccarat_smalleyes_road2, baccarat_roach_road2
        ...
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(3), baccarat_head_road3, baccarat_big_road3, baccarat_bigeyes_road3, baccarat_smalleyes_road3, baccarat_roach_road3
        ...
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(61), baccarat_head_road61, baccarat_big_road61, baccarat_bigeyes_road61, baccarat_smalleyes_road61, baccarat_roach_road61
        ...
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(62), baccarat_head_road62, baccarat_big_road62, baccarat_bigeyes_road62, baccarat_smalleyes_road62, baccarat_roach_road62
        ...
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(63), baccarat_head_road63, baccarat_big_road63, baccarat_bigeyes_road63, baccarat_smalleyes_road63, baccarat_roach_road63
    ...
    private void initRoad71() {
        baseActivity.mAppViewModel.updateRoad(mContext, density, baseActivity.mAppViewModel.getBaccarat(71), baccarat_head_road71, baccarat_big_road71, baccarat_bigeyes_road71, baccarat_smalleyes_road71, baccarat_roach_road71
...
//    }
    ...
    public void InitControl() {
        ...
        shuffling1 = (TextView) rootView.findViewById(R.id.gd__tv_shuffling);
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ll_big_road_parent2_1 = rootView.findViewById(R.id.gd__ll_big_road_parent2);
            ...
            hsv_small_road_1_1 = rootView.findViewById(R.id.gd__hsv_small_road_1);
            ...
            hsv_small_road_2_1 = rootView.findViewById(R.id.gd__hsv_small_road_2);
            ...
            hsv_small_road_3_1 = rootView.findViewById(R.id.gd__hsv_small_road_3);
            ...
            ll_big_road_parent2_1 = rootView.findViewById(R.id.gd__ll_big_road_parent2_landscape);
            ...
            hsv_small_road_1_1 = rootView.findViewById(R.id.gd__hsv_small_road_1_landscape);
            ...
            hsv_small_road_2_1 = rootView.findViewById(R.id.gd__hsv_small_road_2_landscape);
            ...
            hsv_small_road_3_1 = rootView.findViewById(R.id.gd__hsv_small_road_3_landscape);
        ...
        tv_baccarat_timer01 = (TextView) rootView.findViewById(R.id.gd__baccarat_status_tv);
        ...
        tv_baccarat_shoe_number01 = (TextView) rootView.findViewById(R.id.gd__text_shoe_game_number);
        ...
        tv_baccarat_total_number01 = (TextView) rootView.findViewById(R.id.gd__text_total);
        ...
        tv_baccarat_banker_number01 = (TextView) rootView.findViewById(R.id.gd__text_banker);
        ...
        tv_baccarat_player_number01 = (TextView) rootView.findViewById(R.id.gd__text_player);
        ...
        tv_baccarat_tie_number01 = (TextView) rootView.findViewById(R.id.gd__text_tie);
        ...
        tv_baccarat_bp_number01 = (TextView) rootView.findViewById(R.id.gd__text_bp);
        ...
        tv_baccarat_pp_number01 = (TextView) rootView.findViewById(R.id.gd__text_pp);
        ...
        baccarat_head_iv1 = (ImageView) rootView.findViewById(R.id.gd__baccarat_head_iv);
        ...
        tvBaccaratDealerName1 = (TextView) rootView.findViewById(R.id.gd__tv_baccarat_dealer_name);
        ...
        baccarat_background_head_road1 = (GridBackgroundView) rootView.findViewById(R.id.gd__baccarat_background_gridlayout1);
        ...
        smallway1 = (GridBackgroundView) rootView.findViewById(R.id.gd__smallway_item);
        ...
        View smallway21 = rootView.findViewById(R.id.gd__baccarat_gridlayout4);
        ...
        View smallway31 = rootView.findViewById(R.id.gd__baccarat_gridlayout5);
        ...
        View bigway1 = rootView.findViewById(R.id.gd__big_way);
        ...
        ((TextView) rootView.findViewById(R.id.gd__tv_baccarat_table_name)).setText("LB1");
        ...
        rootView.findViewById(R.id.gd__ll_baccarat_content).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                clickGrid(v, 1, "LB1", rootView.findViewById(R.id.gd__ll_parent_limit));
            }
        });
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            if (TextUtils.isEmpty(BuildConfig.FLAVOR) || BuildConfig.FLAVOR.equals("gd88") || BuildConfig.FLAVOR.equals("liga365")){
                ...
                baccaratContentParentLl.addView(view);
            }
...
//    PopChoiceLanguage<String> centerPop;
    ...
    public void initLimitPop(View view, final int tableId, final String tableNumber, final View top_v) {
        rootView.findViewById(R.id.gd__ll_parent_limit).setVisibility(View.GONE);
        if (layout2 != null)
        ...
        baseRecyclerAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener<String>() {
            ...
            public void onItemClick(View view, String s, int position) {
                ...
                if (WebSiteUrl.isDomain) {
                    ...
                    baseActivity.mAppViewModel.setSerialId(0);
                    baseActivity.mAppViewModel.setAreaId(0);
...
//                mAppViewModel.setAreaId(areaId);
    ...
    private ArrayList<String> getLimitData(int tableId) {
        ...
        String limit3 = "0 - 0";
        String limit4 = "0 - 0";
        baccarat = baseActivity.mAppViewModel.getBaccarat(tableId);
