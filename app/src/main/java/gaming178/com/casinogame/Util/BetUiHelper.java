...
public class BetUiHelper {
    public  static void betStateColor(View btn, boolean isBet){
        if(isBet)
            btn.setBackgroundResource(R.drawable.rectangle_yellow_eed2560b_corner5_bet_btn);
        else{
            btn.setBackgroundResource(R.drawable.rectangle_grey6e6e6e_corner5_bet_btn);
        }
    }
