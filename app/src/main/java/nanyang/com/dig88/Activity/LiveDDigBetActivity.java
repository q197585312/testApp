...
public class LiveDDigBetActivity extends GameBaseActivity{
    ...
    @Bind(R.id.ll_smalldouble)
    LinearLayout ll_smalldouble;
    @Bind(R.id.ll_smallsimgle)
    LinearLayout ll_smallsimgle;
    @Bind(R.id.ll_bigdouble)
    LinearLayout ll_bigdouble;
    @Bind(R.id.ll_bigsimgle)
    ...
    @Bind(R.id.tv_simgle)
    TextView tv_simgle;
    @Bind(R.id.tv_smalldouble)
    TextView tv_smalldouble;
    @Bind(R.id.tv_smallsimgle)
    TextView tv_smallsimgle;
    @Bind(R.id.tv_bigdouble)
    TextView tv_bigdouble;
    @Bind(R.id.tv_bigsimgle)
    ...
    @Bind(R.id.manchesic)
    TextView manchesic;
    @Bind(R.id.manchesitl)
    TextView manchesitl;
    @Bind(R.id.asenna)
    TextView asenna;
    @Bind(R.id.tuotenamu)
    TextView tuotenamu;
    @Bind(R.id.nananpudun)
    TextView nananpudun;
    @Bind(R.id.sitewangxi)
    TextView sitewangxi;
    @Bind(R.id.youwentusi)
    TextView youwentusi;
    @Bind(R.id.luoma)
    TextView luoma;
    @Bind(R.id.laqiao)
    TextView laqiao;
    @Bind(R.id.fuoluolunsa)
    ...
    @Bind(R.id.saerke)
    TextView saerke;
    @Bind(R.id.sangpuduoya)
    TextView sangpuduoya;
    @Bind(R.id.guojimilan)
    TextView guojimilan;
    @Bind(R.id.basailuola)
    TextView basailuola;
    @Bind(R.id.huangjiamadeli)
    TextView huangjiamadeli;
    @Bind(R.id.walunxiya)
    TextView walunxiya;
    @Bind(R.id.bairenmulihei)
    TextView bairenmulihei;
    @Bind(R.id.wuerfusibao)
    TextView wuerfusibao;
    @Bind(R.id.mengxing)
    TextView mengxing;
    @Bind(R.id.lewokusen)
    TextView lewokusen;
    @Bind(R.id.saiweiliya)
    TextView saiweiliya;
    @Bind(R.id.biliyalei)
    TextView biliyalei;
    @Bind(R.id.bierbae)
    ...
    @Bind(R.id.boluxiya)
    TextView boluxiya;
    @Bind(R.id.huofenhaimu)
    TextView huofenhaimu;
    @Bind(R.id.balisenger)
    TextView balisenger;
    @Bind(R.id.liang)
    TextView liang;
    @Bind(R.id.molage)
    ...
    @Bind(R.id.masai)
    TextView masai;
    @Bind(R.id.aiyinhuowen)
    TextView aiyinhuowen;
    @Bind(R.id.ajitu)
    TextView ajitu;
    @Bind(R.id.helanaerke)
    TextView helanaerke;
    @Bind(R.id.feiyeruode)
    TextView feiyeruode;
    @Bind(R.id.sengaidian)
    TextView sengaidian;
    @Bind(R.id.boerduo)
    TextView boerduo;
    @Bind(R.id.lier)
    ...
    @Bind(R.id.zewole)
    TextView zewole;
    @Bind(R.id.hailunweien)
    TextView hailunweien;
    @Bind(R.id.gaoninggeng)
    ...
    @Bind(R.id.cong71)
    TextView cong71;
    @Bind(R.id.dejiadeguo)
    TextView dejiadeguo;
    @Bind(R.id.madelijingji)
    TextView madelijingji;
    @Bind(R.id.yincaoyingelan)
    TextView yincaoyingelan;
    @Bind(R.id.yijiayidali1)
    TextView yijiayidali1;
    @Bind(R.id.dejiadeguo1)
    TextView dejiadeguo1;
    @Bind(R.id.yijiayidali)
    TextView yijiayidali;
    @Bind(R.id.fajiafaguo)
    TextView fajiafaguo;
    @Bind(R.id.fajiafaguo1)
    TextView fajiafaguo1;
    @Bind(R.id.xijiaxibanya)
    TextView xijiaxibanya;
    @Bind(R.id.xijiaxibanya1)
    TextView xijiaxibanya1;
    @Bind(R.id.hecaohelan1)
    TextView hecaohelan1;
    @Bind(R.id.hecaohelan)
    TextView hecaohelan;
    @Bind(R.id.jinsheqiudui)
    TextView jinsheqiudui;
    @Bind(R.id.yinseqiudui)
    TextView yinseqiudui;
    @Bind(R.id.liwufu)
    TextView liwufu;
    //代码获取图片
     @Bind(R.id.iv_qieerxi)
     ImageView iv_qieerxi;
    @Bind(R.id.iv_manchesicheng)
    ImageView iv_manchesicheng;
    @Bind(R.id.iv_ashengna)
    ImageView iv_ashengna;
    @Bind(R.id.iv_manchesitelian)
    ImageView iv_manchesitelian;
    @Bind(R.id.iv_tuotenamu)
    ImageView iv_tuotenamu;
    @Bind(R.id.iv_liwupu)
    ImageView iv_liwupu;
    @Bind(R.id.iv_nananpudun)
    ImageView iv_nananpudun;
    @Bind(R.id.iv_siwangxi)
    ImageView iv_siwangxi;
    @Bind(R.id.iv_youwentusi)
    ImageView iv_youwentusi;
    @Bind(R.id.iv_luoma)
    ImageView iv_luoma;
    @Bind(R.id.iv_laqiao)
    ImageView iv_laqiao;
    @Bind(R.id.iv_fuluolunsa)
    ImageView iv_fuluolunsa;
    @Bind(R.id.iv_naboli)
    ImageView iv_naboli;
    @Bind(R.id.iv_renaya)
    ImageView iv_renaya;
    @Bind(R.id.iv_sangpuduoliya)
    ImageView iv_sangpuduoliya;
    @Bind(R.id.iv_guojimilan)
    ImageView iv_guojimilan;
    @Bind(R.id.iv_basailuola)
    ImageView iv_basailuola;
    @Bind(R.id.iv_huangjiamadeli)
    ImageView iv_huangjiamadeli;
    @Bind(R.id.iv_walunxiya)
    ImageView iv_walunxiya;
    @Bind(R.id.iv_saiweiliya)
    ImageView iv_saiweiliya;
    @Bind(R.id.iv_biliya)
    ImageView iv_biliya;
    @Bind(R.id.iv_bierba)
    ImageView iv_bierba;
    @Bind(R.id.iv_saiweta)
    ImageView iv_saiweta;
    @Bind(R.id.iv_baorenmu)
    ImageView iv_baorenmu;
    @Bind(R.id.iv_woerfu)
    ImageView iv_woerfu;
    @Bind(R.id.iv_mengxing)
    ImageView iv_mengxing;
    @Bind(R.id.iv_lewoku)
    ImageView iv_lewoku;
    @Bind(R.id.iv_aogesibao)
    ImageView iv_aogesibao;
    @Bind(R.id.iv_saerke)
    ImageView iv_saerke;
    @Bind(R.id.iv_boluxiya)
    ImageView iv_boluxiya;
    @Bind(R.id.iv_huofenhaomu)
    ImageView iv_huofenhaomu;
    @Bind(R.id.iv_balisenger)
    ...
    @Bind(R.id.iv_masai)
    ImageView iv_masai;
    @Bind(R.id.iv_shengaidian)
    ImageView iv_shengaidian;
    @Bind(R.id.iv_boerduo)
    ImageView iv_boerduo;
    @Bind(R.id.iv_lier)
    ImageView iv_lier;
    @Bind(R.id.iv_mengbiliai)
    ImageView iv_mengbiliai;
    @Bind(R.id.iv_aiyinghuowen)
    ImageView iv_aiyinghuowen;
    @Bind(R.id.iv_ajitu)
    ImageView iv_ajitu;
    @Bind(R.id.iv_helan)
    ImageView iv_helan;
    @Bind(R.id.iv_feiyeruo)
    ImageView iv_feiyeruo;
    @Bind(R.id.iv_weitesai)
    ImageView iv_weitesai;
    @Bind(R.id.iv_zewole)
    ImageView iv_zewole;
    @Bind(R.id.iv_hailunweien)
    ImageView iv_hailunweien;
    @Bind(R.id.iv_gaoninggeng)
