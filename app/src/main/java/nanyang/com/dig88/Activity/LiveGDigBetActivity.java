...
public class LiveGDigBetActivity extends GameBaseActivity{
    ...
    @BindView(R.id.tv4)
    TextView tv4;
    @BindView(R.id.tv_dan1)
    TextView tv_dan1;
    @BindView(R.id.tv_shuang1)
    TextView tv_shuang1;
    @BindView(R.id.tv_xiaoshuang1)
    TextView tv_xiaoshuang1;
    @BindView(R.id.tv_dashuang1)
    TextView tv_dashuang1;
    @BindView(R.id.tv_xiaodan1)
    TextView tv_xiaodan1;
    @BindView(R.id.tv_dadan1)
    TextView tv_dadan1;
    @BindView(R.id.tv_dan2)
    TextView tv_dan2;
    @BindView(R.id.tv_shuang2)
    TextView tv_shuang2;
    @BindView(R.id.tv_xiaoshuang2)
    TextView tv_xiaoshuang2;
    @BindView(R.id.tv_dashuang2)
    TextView tv_dashuang2;
    @BindView(R.id.tv_xiaodan2)
    TextView tv_xiaodan2;
    @BindView(R.id.tv_dadan2)
    TextView tv_dadan2;
