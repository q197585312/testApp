...
public class LiveDigNumberActivity extends GameBaseActivity implements View.OnClickListener {
    ...
    @BindView(R.id.rl_dialog12)
    RelativeLayout rl_dialog12;
    @BindView(R.id.num_fragment12)
    FrameLayout num_fragment12;
    //48balls
    @BindView(R.id.tv_game_name48)
    TextView tv_game_name48;
    @BindView(R.id.tv_time48)
    TextView tv_time48;
    @BindView(R.id.btn_comin48)
    Button btn_comin48;
    @BindView(R.id.refresh_list48)
    ImageView refresh_list48;
    @BindView(R.id.tv_period48)
    TextView tv_period48;
    @BindView(R.id.dianji48)
    ImageView dianji48;
    @BindView(R.id.rl_golden48)
    LinearLayout rl_golden48;
    @BindView(R.id.tv_golden_odds48)
    TextView tv_golden_odds48;
    @BindView(R.id.rl_silver48)
    LinearLayout rl_silver48;
    @BindView(R.id.tv_silver_odds48)
    TextView tv_silver_odds48;
    @BindView(R.id.rl_big48)
    LinearLayout rl_big48;
    @BindView(R.id.tv_big_odds48)
    TextView tv_big_odds48;
    @BindView(R.id.rl_small48)
    LinearLayout rl_small48;
    @BindView(R.id.tv_small_odds48)
    TextView tv_small_odds48;
    @BindView(R.id.rl_double48)
    LinearLayout rl_double48;
    @BindView(R.id.tv_double_odds48)
    TextView tv_double_odds48;
    @BindView(R.id.rl_single48)
    LinearLayout rl_single48;
    @BindView(R.id.tv_single_odds48)
    TextView tv_single_odds48;
    @BindView(R.id.rl_small_double48)
    LinearLayout rl_small_double48;
    @BindView(R.id.tv_small_double_odds48)
    TextView tv_small_double_odds48;
    @BindView(R.id.rl_big_double48)
    LinearLayout rl_big_double48;
    @BindView(R.id.tv_big_double_odds48)
    TextView tv_big_double_odds48;
    @BindView(R.id.rl_small_single48)
    LinearLayout rl_small_single48;
    @BindView(R.id.tv_small_single_odds48)
    TextView tv_small_single_odds48;
    @BindView(R.id.rl_big_single48)
    LinearLayout rl_big_single48;
    @BindView(R.id.tv_big_single_odds48)
    TextView tv_big_single_odds48;
    @BindView(R.id.tv_toumingdu48)
    TextView tv_toumingdu48;
    @BindView(R.id.rl_dialog48)
    RelativeLayout rl_dialog48;
    @BindView(R.id.num_fragment48)
    FrameLayout num_fragment48;
    //SICBO
    @BindView(R.id.tv_game_namesicbo)
    TextView tv_game_namesicbo;
    @BindView(R.id.tv_timesicbo)
    TextView tv_timesicbo;
    @BindView(R.id.btn_cominsicbo)
    Button btn_cominsicbo;
    @BindView(R.id.refresh_listsicbo)
    ImageView refresh_listsicbo;
    @BindView(R.id.tv_periodsicbo)
    TextView tv_periodsicbo;
    @BindView(R.id.dianjisicbo)
    ...
    Button btn_number_6;
    @BindView(R.id.rl_bigsicbo)
    LinearLayout rl_bigsicbo;
    @BindView(R.id.tv_big_oddssicbo)
    TextView tv_big_oddssicbo;
    @BindView(R.id.rl_smallsicbo)
    LinearLayout rl_smallsicbo;
    @BindView(R.id.tv_small_oddssicbo)
    TextView tv_small_oddssicbo;
    @BindView(R.id.rl_doublesicbo)
    LinearLayout rl_doublesicbo;
    @BindView(R.id.tv_double_oddssicbo)
    TextView tv_double_oddssicbo;
    @BindView(R.id.rl_singlesicbo)
    LinearLayout rl_singlesicbo;
    @BindView(R.id.tv_single_oddssicbo)
    TextView tv_single_oddssicbo;
    @BindView(R.id.tv_toumingdusicbo)
    TextView tv_toumingdusicbo;
    @BindView(R.id.rl_dialogsicbo)
    RelativeLayout rl_dialogsicbo;
    @BindView(R.id.num_fragmentsicbo)
    FrameLayout num_fragmentsicbo;
    //ROULETTE BALLS
    @BindView(R.id.tv_game_nameroulette)
    TextView tv_game_nameroulette;
    @BindView(R.id.tv_timeroulette)
    TextView tv_timeroulette;
    @BindView(R.id.btn_cominroulette)
    Button btn_cominroulette;
    @BindView(R.id.refresh_listroulette)
    ImageView refresh_listroulette;
    @BindView(R.id.tv_periodroulette)
    TextView tv_periodroulette;
    @BindView(R.id.dianjiroulette)
    ImageView dianjiroulette;
    @BindView(R.id.rl_redred)
    LinearLayout rl_redred;
    @BindView(R.id.tv_redred_odds)
    TextView tv_redred_odds;
    @BindView(R.id.rl_black)
    LinearLayout rl_black;
    @BindView(R.id.tv_black_odds)
    TextView tv_black_odds;
    @BindView(R.id.rl_bigroulette)
    LinearLayout rl_bigroulette;
    @BindView(R.id.tv_big_oddsroulette)
    TextView tv_big_oddsroulette;
    @BindView(R.id.rl_smallroulette)
    LinearLayout rl_smallroulette;
    @BindView(R.id.tv_small_oddsroulette)
    TextView tv_small_oddsroulette;
    @BindView(R.id.rl_doubleroulette)
    LinearLayout rl_doubleroulette;
    @BindView(R.id.tv_double_oddsroulette)
    TextView tv_double_oddsroulette;
    @BindView(R.id.rl_singleroulette)
    LinearLayout rl_singleroulette;
    @BindView(R.id.tv_single_oddsroulette)
    TextView tv_single_oddsroulette;
    @BindView(R.id.tv_toumingduroulette)
    TextView tv_toumingduroulette;
    @BindView(R.id.rl_dialogroulette)
    RelativeLayout rl_dialogroulette;
    @BindView(R.id.num_fragmentroulette)
    FrameLayout num_fragmentroulette;
    //MULTIPLE 36BALLS
    @BindView(R.id.tv_game_namemult)
    TextView tv_game_namemult;
    @BindView(R.id.tv_timemult)
    TextView tv_timemult;
    @BindView(R.id.btn_cominmult)
    Button btn_cominmult;
    @BindView(R.id.refresh_listmult)
    ImageView refresh_listmult;
    @BindView(R.id.tv_periodmult)
    TextView tv_periodmult;
    @BindView(R.id.dianjimult)
    ImageView dianjimult;
    /////ceshi
    @BindView(R.id.tv_toumingdu49)
    TextView tv_toumingdu49;
    @BindView(R.id.rl_dialog49)
    RelativeLayout rl_dialog49;
    @BindView(R.id.num_fragment49)
    FrameLayout num_fragment49;
    /////////lanjian tianjia
    @BindView(R.id.ll_item42)
    LinearLayout live_linearlayout42;
    @BindView(R.id.ll_item36)
    LinearLayout live_linearlayout36;
    @BindView(R.id.ll_item12)
    LinearLayout live_linearlayout12;
    @BindView(R.id.ll_item48)
    LinearLayout live_linearlayout48;
    @BindView(R.id.ll_itemsicbo)
    LinearLayout live_linearlayout_sicbo;
    @BindView(R.id.ll_itemroulette)
    LinearLayout live_linearlayout_roulette;
    @BindView(R.id.ll_itemmult)
    ...
    @BindView(R.id.b_imageView_video_42)
    IjkVideoView b_imageView_video_42;
    @BindView(R.id.b_imageView_video_36)
    IjkVideoView b_imageView_video_36;
    @BindView(R.id.b_imageView_video_12)
    IjkVideoView b_imageView_video_12;
    @BindView(R.id.b_imageView_video_48)
    IjkVideoView b_imageView_video_48;
    @BindView(R.id.b_imageView_video_sicbo)
    IjkVideoView b_imageView_video_sicbo;
    @BindView(R.id.b_imageView_video_roulette)
    IjkVideoView b_imageView_video_roulette;
    @BindView(R.id.b_imageView_video_mult)
    IjkVideoView b_imageView_video_mult;
    @BindView(R.id.img_42)
    ImageView img_42;
    @BindView(R.id.img_36)
    ImageView img_36;
    @BindView(R.id.img_12)
    ImageView img_12;
    @BindView(R.id.img_48)
    ImageView img_48;
    @BindView(R.id.img_sicbo)
    ImageView img_sicbo;
    @BindView(R.id.img_roulette)
    ImageView img_roulette;
    @BindView(R.id.img_mult)
    ImageView img_mult;
    @BindView(R.id.btn_stop_42)
    Button btn_stop_42;
    @BindView(R.id.btn_stop_36)
    Button btn_stop_36;
    @BindView(R.id.btn_stop_12)
    Button btn_stop_12;
    @BindView(R.id.btn_stop_48)
    Button btn_stop_48;
    @BindView(R.id.btn_stop_sicbo)
    Button btn_stop_sicbo;
    @BindView(R.id.btn_stop_roulette)
    Button btn_stop_roulette;
    @BindView(R.id.btn_stop_mult)
    Button btn_stop_mult;
    @BindView(R.id.b_text_video)
    TextView b_text_video;
    @BindView(R.id.b_text_video_36)
    TextView b_text_video_36;
    @BindView(R.id.b_text_video_12)
    TextView b_text_video_12;
    @BindView(R.id.b_text_video_48)
    TextView b_text_video_48;
    @BindView(R.id.b_text_video_sicbo)
    TextView b_text_video_sicbo;
    @BindView(R.id.b_text_video_roulette)
    TextView b_text_video_roulette;
    @BindView(R.id.b_text_video_mult)
