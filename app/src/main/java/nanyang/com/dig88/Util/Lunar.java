...
public class Lunar {
    ...
    public Lunar(Calendar cal, Context mContext) {
    ...
    final public String animalsYear() {
        final String[] Animals = new String[]{mContext.getString(R.string.shu), mContext.getString(R.string.niu), mContext.getString(R.string.hu), mContext.getString(R.string.tu),
                mContext.getString(R.string.lon), mContext.getString(R.string.she), mContext.getString(R.string.ma), mContext.getString(R.string.yang),
                mContext.getString(R.string.hou), mContext.getString(R.string.ji), mContext.getString(R.string.gou), mContext.getString(R.string.zhu)};
...
////        today.setTime(chineseDateFormat.parse("2018-2-15"));//加载自定义日期
