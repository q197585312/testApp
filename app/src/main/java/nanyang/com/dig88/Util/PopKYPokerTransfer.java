...
import nanyang.com.dig88.Activity.KYPokerActivity;
...
public class PopKYPokerTransfer extends BasePopupWindow implements View.OnClickListener {
    String balanceUrl = "https://kaiyuan.k-api.com/balance.php";
    String buyUrl = "https://kaiyuan.k-api.com/transfer.php";
    String takeOutUrl = "https://kaiyuan.k-api.com/transfer.php";
    UserInfoBean u;
    BaseActivity aty;
    String buyMoney;
    String takeOutMoney;
    ...
    public PopKYPokerTransfer(Context context, View v, int width, int height) {
    ...
    protected void initView(View view) {
        ...
        tv_lottery_balance_name.setText("Kai Yuan" + context.getString(R.string.Balance));
        ...
        typeTakeOut = 2;
        typeGetBalance = 3;
        balanceUrl = "https://kaiyuan.k-api.com/balance.php";
        buyUrl = "https://kaiyuan.k-api.com/transfer.php";
        takeOutUrl = "https://kaiyuan.k-api.com/transfer.php";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_start:
                closePopupWindow();
                AppTool.activiyJump(context, KYPokerActivity.class);
                break;
        }
    }
    ...
    private void request() {
        ...
        if (requestType == typeBuy) {
            requestUrl = buyUrl;
            param += "&from=1" + "&to=1036" + "&amount=" + buyMoney;
        } else if (requestType == typeTakeOut) {
            requestUrl = takeOutUrl;
            param += "&from=1036" + "&to=1" + "&amount=" + takeOutMoney;
        }
        OkhttpUtils.getRequest(requestUrl + param, new OkhttpUtils.Result() {
            ...
            public void onSuccess(String result) {
                if (requestType == typeBuy || requestType == typeTakeOut) {
                    ...
                    KYPokerBalanceBean balanceBean = gson.fromJson(result, KYPokerBalanceBean.class);
                    if (balanceBean.getCode().equals("0")) {
                        tv_poker_balance.setText(balanceBean.getM_balance() + "(" + balanceBean.getBalance() + ")");
                    } else {
