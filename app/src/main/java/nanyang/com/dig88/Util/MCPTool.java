...
public class MCPTool {
	 ...
	 */
	public static final byte[] IV = new byte[] { 1, 3, 1, 4, 5, 2, 0, 1 };
	...
	public static void write(File path, byte[] content, String password) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static byte[] read(File path, String password) throws Exception {
	 ...
	 * @throws IOException
	 */
	public static Object[] getVersion(RandomAccessFile raf) throws IOException {
		String version = null;
		byte[] bytesMagic = SIG.getBytes(CHARSET_NAME);
		byte[] bytes = new byte[bytesMagic.length];
	 ...
	 * @throws IOException
	 */
	public static void readFully(RandomAccessFile raf, long index, byte[] buffer) throws IOException {
		raf.seek(index);
	 ...
	 * @return
	 */
	public static String getPackageCodePath(Object context) {
		try {
	 ...
	 * @throws Exception
	 */
	public static byte[] encrypt(String password, byte[] content) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static byte[] decrypt(String password, byte[] content) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static byte[] cipher(int cipherMode, String password, byte[] content) throws Exception {
