...
import xs.com.mylibrary.myview.mylistview.HorizontalListView;
...
public abstract class KenoBaseFragment extends BaseFragment{
    ...
    @Bind(R.id.btn_bet_big)
    LinearLayout btnBetBig;
    @Bind(R.id.btn_bet_tie)
    LinearLayout btnBetTie;
    @Bind(R.id.btn_bet_small)
    LinearLayout btnBetSmall;
    @Bind(R.id.btn_bet_odd)
    LinearLayout btnBetOdd;
    @Bind(R.id.btn_bet_even)
    LinearLayout btnBetEven;
    @Bind(R.id.btn_bet_small_even)
    LinearLayout btnBetSmallEven;
    @Bind(R.id.btn_bet_small_odd)
    LinearLayout btnBetSmallOdd;
    @Bind(R.id.btn_bet_big_even)
    LinearLayout btnBetBigEven;
    @Bind(R.id.btn_bet_big_odd)
    LinearLayout btnBetBigOdd;
    @Bind(R.id.btn_bet_wood)
    LinearLayout btnBetWood;
    @Bind(R.id.btn_bet_water)
    LinearLayout btnBetWater;
    @Bind(R.id.btn_bet_fire)
    LinearLayout btnBetFire;
    @Bind(R.id.btn_bet_earth)
    LinearLayout btnBetEarth;
    @Bind(R.id.btn_bet_gold)
    LinearLayout btnBetGold;
    @Bind(R.id.tv_keno_big_odds)
    TextView tvKenoBigOdds;
    @Bind(R.id.tv_keno_tie_odds)
    TextView tvKenoTieOdds;
    @Bind(R.id.tv_keno_small_odds)
    TextView tvKenoSmallOdds;
    @Bind(R.id.tv_keno_odd_odds)
    TextView tvKenoOddOdds;
    @Bind(R.id.tv_keno_even_odds)
    TextView tvKenoEvenOdds;
    @Bind(R.id.tv_keno_seven_odds)
    TextView tvKenoSevenOdds;
    @Bind(R.id.tv_keno_sodd_odds)
    TextView tvKenoSoddOdds;
    @Bind(R.id.tv_keno_beven_odds)
    TextView tvKenoBevenOdds;
    @Bind(R.id.tv_keno_bodd_odds)
    TextView tvKenoBoddOdds;
    @Bind(R.id.tv_keno_gold_odds)
    TextView tvKenoGoldOdds;
    @Bind(R.id.tv_keno_wood_odds)
    TextView tvKenoWoodOdds;
    @Bind(R.id.tv_keno_water_odds)
    TextView tvKenoWaterOdds;
    @Bind(R.id.tv_keno_fire_odds)
    TextView tvKenoFireOdds;
    @Bind(R.id.tv_keno_earth_odds)
    TextView tvKenoEarthOdds;
    @Bind(R.id.fl_keno_progress_parent)
    FrameLayout flKenoProgressParent;
    @Bind(R.id.tv_keno_timer)
    TextView tvKenoTimer;
    @Bind(R.id.tv_keno_series_number)
    TextView tvKenoSeriesNumber;
    @Bind(R.id.tv_keno_country)
    TextView tvKenoCountry;
    @Bind(R.id.tv_enter)
    TextView tvEnter;
    @Bind(R.id.fgv_keno_result_header)
    GridView fgvKenoResultHeader;
    @Bind(R.id.fgv_keno_result)
    GridView fgvKenoResult;
    @Bind(R.id.hlst_keno_content)
