...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private String refreshStr="下拉刷新";
	private String loadStr="上拉加载下一页";
	private String releaseToLoad="释放立即加载";
	private String releaseToRefresh="释放立即刷新";

	public void setReleaseToLoad(String releaseToLoad) {
		this.releaseToLoad = releaseToLoad;
	}
	...
	public void setRefreshStr(String refreshStr){
		...
		if(refreshStateTextView!=null)
			refreshStateTextView.setText(refreshStr);
	}
	public void setLoadStr(String load){
		if(loadStateTextView!=null)
			loadStateTextView.setText(load);
		this.loadStr=load;
	}
	...
	private void changeState(int to)
	{
		...
		case INIT:
			...
			loadStateTextView.setText(loadStr);
			pullUpView.clearAnimation();
			pullUpView.setVisibility(View.VISIBLE);
			break;
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			refreshStateTextView.setText(releaseToRefresh);
		...
		case RELEASE_TO_LOAD:
			// 释放加载状态
			loadStateTextView.setText(releaseToLoad);
