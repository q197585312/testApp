...
package gaming178.com.mylibrary.myview.indicator;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indexColor=R.color.red_title;
...
//		tabTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSize, dm);
		...
		tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_tabBground, tabBackgroundResId);
