...
import gaming178.com.mylibrary.BuildConfig;

/**
 * ListView, which is capable to pin section views at its top while the rest is still scrolled.
 */
public class PinnedSectionListView extends ListView implements Pullable{
...
//        mGestureDetector = new GestureDetector(new YScrollDetector());
    ...
    public PinnedSection getmPinnedSection() {
        return mPinnedSection;
    }
