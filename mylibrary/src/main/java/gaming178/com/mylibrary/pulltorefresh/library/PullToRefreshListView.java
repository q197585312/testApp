...
import gaming178.com.mylibrary.pulltorefresh.library.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends
    ...
    protected LoadingLayoutProxy createLoadingLayoutProxy(
        ...
        if (mListViewExtrasEnabled) {
            ...
            if (includeStart && mode.showHeaderLoadingLayout()) {
                mHeaderLoadingView.setTheType(0);
                proxy.addLayout(mHeaderLoadingView);
            }
            if (includeEnd && mode.showFooterLoadingLayout()) {
                mFooterLoadingView.setTheType(1);
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
            ...
            deltaY = Math.max(-MAX_SCROLLER_DISTANCE,
                    Math.min(MAX_SCROLLER_DISTANCE, deltaY));
