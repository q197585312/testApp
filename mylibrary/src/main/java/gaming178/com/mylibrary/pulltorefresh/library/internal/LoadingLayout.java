 ...
 *******************************************************************************/
package gaming178.com.mylibrary.pulltorefresh.library.internal;
...
import gaming178.com.mylibrary.pulltorefresh.library.ILoadingLayout;
import gaming178.com.mylibrary.pulltorefresh.library.PullToRefreshBase.Mode;
import gaming178.com.mylibrary.pulltorefresh.library.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
    ...
    private int mPullResourceId;
    private int mRefreshingResourceId;
    private int mReleaseResourceId;
    private int mPullLoadingDrawableVisibility = View.VISIBLE;
    private int mRefreshingLoadingDrawableVisibility = View.VISIBLE;
    private int mReleaseLoadingDrawableVisibility = View.VISIBLE;
    ...
    public final void pullToRefresh() {
        if (null != mHeaderText) {
            ...
            mHeaderText.setBackgroundResource(mPullResourceId);
        }

        mHeaderImage.setVisibility(mPullLoadingDrawableVisibility);
    ...
    public final void refreshing() {
        if (null != mHeaderText) {
            ...
            mHeaderText.setBackgroundResource(mRefreshingResourceId);
        }

        mHeaderImage.setVisibility(mRefreshingLoadingDrawableVisibility);
    ...
    public final void releaseToRefresh() {
        if (null != mHeaderText) {
            ...
            mHeaderText.setBackgroundResource(mReleaseResourceId);
        }

        mHeaderImage.setVisibility(mReleaseLoadingDrawableVisibility);
