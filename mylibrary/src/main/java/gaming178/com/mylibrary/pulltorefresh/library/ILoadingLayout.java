...
public interface ILoadingLayout {
    ...
    // --------------------------------------------
    void setPullLoadingDrawableVisibility(int visibility);

    void setRefreshingLoadingDrawableVisibility(int visibility);

    void setReleaseLoadingDrawableVisibility(int visibility);

    void setPullImageResource(int resourceId);

    void setRefreshingImageResource(int resourceId);

    void setReleaseImageResource(int resourceId);
}
