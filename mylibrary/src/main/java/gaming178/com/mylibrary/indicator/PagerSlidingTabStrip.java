...
package gaming178.com.mylibrary.indicator;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indexColor = R.color.white;
    ...
    private int underlineColor = 0x66000000;
    ...
    private int tabTextColor = 0xcfd8dc;
...
//		tabTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSize, dm);
        ...
        dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPad, dividerPadding);
        ...
        textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_allCaps, textAllCaps);
    ...
    private void selectedBackground(TextView tabTextView) {
        if (selectedBgColor == 0) {
            if (!TextUtils.isEmpty(webId) && (webId.equals("2"))) {
                tabTextView.setBackgroundColor(0xfff6f900);
            } else {
