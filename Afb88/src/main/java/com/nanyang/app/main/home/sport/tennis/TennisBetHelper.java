...
public class TennisBetHelper extends BallBetHelper<TennisInfo,BetView> {
    ...
    protected String getOddsUrl(TennisInfo item, String type, boolean isHf, String odds) {
    ...
    @Override
    public Disposable clickOdds(TennisInfo item, String type, String odds, final TextView v, final boolean isHf) {
