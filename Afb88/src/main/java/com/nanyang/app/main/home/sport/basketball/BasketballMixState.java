...
public abstract class BasketballMixState extends SportState<BasketballMixInfo, SportContract2.View<BasketballMixInfo>> {
    ...
    private BasketballMixInfo parseMatch(JSONArray matchArray) throws JSONException {
        ...
        info.setSocOddsId(matchArray.getString(0)==null?"":matchArray.getString(0));
        info.setHasRunning(matchArray.opt(1)==null?"":matchArray.getString(1));
        info.setLive(matchArray.opt(2)==null?"":matchArray.getString(2));
        info.setIsLastCall(matchArray.getString(3)==null?"":matchArray.getString(3));
        info.setMatchDate(matchArray.getString(4)==null?"":matchArray.getString(4));
        info.setIsHomeGive(matchArray.getString(5)==null?"":matchArray.getString(5));
        info.setHome(matchArray.getString(6)==null?"":matchArray.getString(6));
        info.setAway(matchArray.getString(7)==null?"":matchArray.getString(7));
        info.setIsInetBet(matchArray.getString(8)==null?"":matchArray.getString(8));
        info.setHasHdp(matchArray.getString(9)==null?"":matchArray.getString(9));
        info.setHdp(matchArray.getString(10)==null?"":matchArray.getString(10));
        info.setHdpOdds(matchArray.getString(11)==null?"":matchArray.getString(11));
        info.setHomeHdpOdds(matchArray.getString(12)==null?"":matchArray.getString(12));
        info.setAwayHdpOdds(matchArray.getString(13)==null?"":matchArray.getString(13));
        info.setHasOU(matchArray.getString(14)==null?"":matchArray.getString(14));
        info.setOU(matchArray.getString(15)==null?"":matchArray.getString(15));
        info.setIsHdpNew(matchArray.getString(16)==null?"":matchArray.getString(16));
        info.setIsOUNew(matchArray.getString(17)==null?"":matchArray.getString(17));
        info.setOUOdds(matchArray.getString(18)==null?"":matchArray.getString(18));
        info.setOverOdds(matchArray.getString(19)==null?"":matchArray.getString(19));
        info.setUnderOdds(matchArray.getString(20)==null?"":matchArray.getString(20));
        info.setIsOENew(matchArray.getString(21)==null?"":matchArray.getString(21));
        info.setHasOE(matchArray.getString(22)==null?"":matchArray.getString(22));
        info.setOEOdds(matchArray.getString(23)==null?"":matchArray.getString(23));
        info.setOddOdds(matchArray.getString(24)==null?"":matchArray.getString(24));
        info.setEvenOdds(matchArray.getString(25)==null?"":matchArray.getString(25));
        info.setIsX12New(matchArray.getString(26)==null?"":matchArray.getString(26));
        info.setHasX12(matchArray.getString(27)==null?"":matchArray.getString(27));
        info.setX12_1Odds(matchArray.getString(28)==null?"":matchArray.getString(28));
        info.setX12_XOdds(matchArray.getString(29)==null?"":matchArray.getString(29));
        info.setX12_2Odds(matchArray.getString(30)==null?"":matchArray.getString(30));
        info.setPreSocOddsId(matchArray.getString(31)==null?"":matchArray.getString(31));
        return info;
