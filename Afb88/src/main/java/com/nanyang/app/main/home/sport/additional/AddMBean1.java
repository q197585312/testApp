...
public class AddMBean1 implements Serializable {

    /**
     * ModuleTitle : 2
     * SocOddsId : 770823
     * LeagueName : AUSTRALIA HYUNDAI A LEAGUE
     * homeName : Wellington Phoenix
     * awayName : Melbourne City
     * live : 21/04 15:00 PM
     * Param : 'pgajaxS.axd?T=MB2&ot=&oId=770823&home=&away=&moduleTitle=&date='
     * Betable : True
     * O2 : O
     * U2 : U
     * FTHDP_CNT : 2
     * FTodds : [{"SocOddsId":"770823","Home":"Home","Away":"Away","HDP":"0.25","Hdp_visible":"True","HomeOdds":"-9.1","AwayOdds":"8.3","Over":"Over","Under":"Under","OU":"2.75","OU_visible":"True","OverOdds":"8.8","UnderOdds":"-9.8","IsHomeGive":"True","IsRun":"False","HasPar":"True"},{"SocOddsId":"770824","Home":"Home","Away":"Away","HDP":"0","Hdp_visible":"True","HomeOdds":"7.8","AwayOdds":"-8.6","Over":"Over","Under":"Under","OU":"3","OU_visible":"True","OverOdds":"-8.4","UnderOdds":"7.4","IsHomeGive":"True","IsRun":"False","HasPar":"True"}]
     * FHHDP_CNT : 1
     * FHodds : [{"SocOddsId":"770848","Home":"Home","Away":"Away","HDP":"0","Hdp_visible":"True","HomeOdds":"7.9","AwayOdds":"-9.1","Over":"Over","Under":"Under","OU":"1.25","OU_visible":"True","OverOdds":"-8.5","UnderOdds":"7.3","IsHomeGive":"True","IsRun":"False","HasPar":"True"}]
     * FTMModds : [{"HDPH":"0-26H","HDPA":"","SocOddsId":"770823","HomeOdds":"9.5","AwayOdds":"9.5","OU":"340","OverOdds":"9.4","UnderOdds":"9.4","IsRun":"False","IsInetBet":"True","IsLastCall":"0","HasHdp":"True","HdpOdds":"-8.1","OUOdds":"9.8","HasOU":"True","RunHomeScore":"0","RunAwayScore":"0","RTSMatchId":"0","HasPar":"True"}]
     * FHMModds : []
     * F1X2_CNT : 1
     * F1X2_SocOddsId : 770823
     * F1X2_IsRun : False
     * HasPar : True
     * 1IsInetBet : True
     * F1 : 2.39
    ...
    public String HTTG_FHSocOddsId;
    ...
    public void setHOE_SocOddsId(String HOE_SocOddsId) {
        this.HOE_SocOddsId = HOE_SocOddsId;
    }

    public String getHOE_IsRun() {
        return HOE_IsRun;
    }

    public void setHOE_IsRun(String HOE_IsRun) {
        this.HOE_IsRun = HOE_IsRun;
    }

    public String getHOE_HasPar() {
        return HOE_HasPar;
    }

    public void setHOE_HasPar(String HOE_HasPar) {
        this.HOE_HasPar = HOE_HasPar;
    }
    ...
    public void setHOddIsInetBet(String HOddIsInetBet) {
        this.HOddIsInetBet = HOddIsInetBet;
    }
    ...
    public void setHEvenIsInetBet(String HEvenIsInetBet) {
        this.HEvenIsInetBet = HEvenIsInetBet;
    }
    ...
    public void setHEven(String HEven) {
        this.HEven = HEven;
    }
