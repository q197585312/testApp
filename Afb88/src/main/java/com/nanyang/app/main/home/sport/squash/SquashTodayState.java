...
public class SquashTodayState extends SquashState {
    ...
    protected String getRefreshUrl() {
        return AppConstant.getInstance().URL_SQUASH_TODAY;
    }
    ...
    public MenuItemInfo getStateType() {
        return new MenuItemInfo<String>(0, getBaseView().getIBaseContext().getBaseActivity().getString(R.string.Today), "Today", getBaseView().getIBaseContext().getBaseActivity().getString(R.string.Squash));
    }
