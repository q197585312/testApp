...
public abstract class TennisState extends BasketballCommonState{
    ...
    protected List<List<String>> initHeaderList() {
        ...
        List<String> items0 = new ArrayList<>(Arrays.asList(getBaseView().getContextActivity().getString(R.string.TO_WIN), getBaseView().getContextActivity().getString(R.string.HANDICAP)));
        List<String> items1 = new ArrayList<>(Arrays.asList(getBaseView().getContextActivity().getString(R.string.O_U), getBaseView().getContextActivity().getString(R.string.ODD_EVEN)));
        texts.add(items0);
        texts.add(items1);
        return texts;
    }
