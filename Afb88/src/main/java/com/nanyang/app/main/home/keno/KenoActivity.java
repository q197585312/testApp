...
public class KenoActivity extends BaseToolbarActivity<KenoPresenter> {
    ...
    @BindView(R.id.rb_canada1)
    RadioButton rb_canada1;
    @BindView(R.id.rb_canada2)
    RadioButton rb_canada2;
    @BindView(R.id.rb_slovakia)
    RadioButton rb_slovakia;
    @BindView(R.id.rb_australia)
    ...
    @BindView(R.id.tv_up_odds)
    TextView tv_up_odds;
    @BindView(R.id.tv_down_odds)
    TextView tv_down_odds;
    @BindView(R.id.tv_odd_odds)
    TextView tv_odd_odds;
    @BindView(R.id.tv_even_odds)
    ...
    TextView tv_result;
    @BindView(R.id.ll_bet1)
    LinearLayout ll_bet1;
    @BindView(R.id.ll_drawing_close)
    LinearLayout ll_drawing_close;
    @BindView(R.id.tv_drawing_close)
