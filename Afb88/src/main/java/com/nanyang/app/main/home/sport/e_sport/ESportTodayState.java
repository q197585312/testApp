...
public class ESportTodayState extends ESportState {
    public ESportTodayState(SportContract.View baseView) {
        super(baseView);
    }
    ...
    public MenuItemInfo getStateType() {
        return new MenuItemInfo<String>(0, (R.string.Today), "Today", getBaseView().getIBaseContext().getBaseActivity().getString(R.string.E_Sport));
    }
