...
public class SquashRunningState extends SquashState {
    public SquashRunningState(SportContract.View baseView) {
        super(baseView);
    }
    ...
    protected String getRefreshUrl() {
        return AppConstant.getInstance().URL_SQUASH_RUNING;
    }
    ...
    public MenuItemInfo getStateType() {
        return new MenuItemInfo<String>(0, getBaseView().getIBaseContext().getBaseActivity().getString(R.string.running), "Running", getBaseView().getIBaseContext().getBaseActivity().getString(R.string.Squash));
    }
