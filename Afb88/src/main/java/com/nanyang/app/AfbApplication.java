...
//        return marketType;
    ...
    private static void putOtherMap(LinkedHashMap<String, SportIdBean> map, BaseSportFragment soccerFragment) {
        if (BuildConfig.FLAVOR.equals("ez2888")) {
            ...
            map.put("Lucky361", new SportIdBean("Lucky361", "", R.string.lucky361_casino, "Lucky361", SportActivity.class, soccerFragment, Color.BLACK, R.mipmap.other_lucky361_slot_gaming));
            map.put("JILI", new SportIdBean("JILI", "", R.string.jili_casino, "JILI", SportActivity.class, soccerFragment, Color.BLACK, R.mipmap.other_jili_slot_gaming));
...
//        map.put("betsoft", new SportIdBean("betsoft", "", R.string.betsoft, "betsoft", SportActivity.class, soccerFragment, Color.BLACK, R.mipmap.bts_gaming));
            ...
            map.put("TopTrend", new SportIdBean("TopTrend", "", R.string.toptrend_game, "TopTrend", SportActivity.class, soccerFragment, Color.BLACK, R.mipmap.other_toptrend));
...
//        sportMap.put("122", soccerEuro_2020);
    ...
    public synchronized String getRefreshMixOddsUrl() {
        ...
        if (getMixBetList().size() == 1) {
            ...
            betOddsUrl = "BTMD=P&coupon=" + coupon + "&BETID=" + ids;
        }
        return AppConstant.getInstance().URL_ODDS + betOddsUrl;
    ...
    public Map<String, String> updateOtherMap() {
        ...
        enableMap.put("JILI", isEnabledWM);
        enableMap.put("Lucky361", isEnabledWM);
        enableMap.put("TopTrend", isEnabledWM);
        return enableMap;
    }
