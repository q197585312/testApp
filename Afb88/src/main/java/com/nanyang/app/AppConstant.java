...
//    public static String HOST="http://www.doo88.net/";
    ...
    public static String URL_FOOTBALL_RUNNING = HOST + "_view/RMOddsGen1.ashx?ot=r&ov=0&tf=-1&TFStatus=0&update=false&r=153004462";
    public static String URL_FOOTBALL_TODAY = HOST + "_view/RMOddsGen1.ashx?ot=t&ov=0&tf=-1&TFStatus=0&update=false&r=153004462&wd=&ia=0";
    public static String URL_FOOTBALL_EARLY = HOST + "_view/RMOddsGen1.ashx?ot=e&ov=0&tf=2&TFStatus=0&update=false&r=246503518";
